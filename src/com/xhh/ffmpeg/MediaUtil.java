package com.xhh.ffmpeg;

import com.xhh.ffmpeg.domain.ImageMetaInfo;
import com.xhh.ffmpeg.domain.VideoMetaInfo;
import com.xhh.ffmpeg.domain.gif.AnimatedGifEncoder;
...
public class MediaUtil {
	...
	public static String executeCommand(List<String> commonds) {
		...
		try {
			...
			// 输出执行的命令信息
			String s = Arrays.toString(ffmpegCmds.toArray());
			String cmdStr =s.replace(",", "");
